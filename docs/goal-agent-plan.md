...
**Status:** G1 built on branch `goal-agents` — the store, the scratchpad, the four
`goal_*` tools, the 30-minute heartbeat in the daemon, the journal, and the REST
surface. Everything else below is still plan. Supersedes the first draft
